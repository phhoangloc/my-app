...
export const Sidebar = () => {
    ...
    return (
        <div className={`fixed z-2 top-0 backdrop-brightness-50 backdrop-blur-xs transition-all duration-200 ${_currentMenu ? "w-full " : "w-0 delay-500"} h-screen sm:sticky sm:w-60 sm:z-0 sm:h-(--vh-12) sm:top-12`}>
